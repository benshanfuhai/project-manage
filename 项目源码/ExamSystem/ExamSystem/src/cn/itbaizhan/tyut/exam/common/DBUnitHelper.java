...
public class DBUnitHelper {
	...
	public static Connection getConn() {
		...
		try {
			...
			conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/exam?characterEncoding=utf8", "root", "wang");
	 ...
	 * con=getConn(); for(int i=0;i<=700;i++){ String sql="insert into r values(?)";
	 * PreparedStatement pstmt=con.prepareStatement(sql); pstmt.setInt(1, i);
	 * pstmt.executeUpdate(); System.out.println("插入成功"+i); } }
	 */
}
